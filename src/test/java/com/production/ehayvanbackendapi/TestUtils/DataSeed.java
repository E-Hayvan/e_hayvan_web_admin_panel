package com.production.ehayvanbackendapi.TestUtils;
...
public class DataSeed {
    ...
    @Autowired
    public DataSeed(PetOwnerRepository petOwnerRepo,
    ...
    public void loadSeedToDatabase() {
        // Seed medTypeRepository
    ...
    // Implemented for deleting all data in database
    // after each test. But at the moment, it should
    // not be used due to the fact that IDs of tables is
    // not resetted after delete operation. Look at
    // 111th, 119th, 148th and 188th lines.
    @Deprecated
